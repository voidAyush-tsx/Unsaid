...
export default function Home() {
  ...
  const redirectUser = (loggedInPath: string, guestPath: string) => {
    if (user) {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col m-0">
      ...
      <div className="flex flex-col px-48 py-36 items-center justify-center align-middle">
        <h1
          className="font-unsaid font-extrabold mb-16"
        ...
        >
          At Unsaid, we believe that every emotion, every struggle, and every
          unspoken thought deserves to be acknowledged. Our journey began with a
          simple yet powerful idea—to create a safe and supportive platform for
          those navigating anxiety, stress, and mental well-being. We understand
          that sometimes, words fail us, but feelings remain. That&apos;s why we
          built Unsaid—a space where guidance, support, and healing come
          together.
        </p>
        ...
        <button
          ...
          onClick={() => redirectUser("/connect", "/signin")}
        >
          <div
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div>
            ...
            <button
              ...
              style={{ color: "#fff", fontSize: "18px" }}
              onClick={() => redirectUser("/connect/test", "/signin")}
            >
